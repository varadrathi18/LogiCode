// // Namespace prefix for French Beginner
// const storagePrefix = 'fr-beginner-';

// // Initialize lives and points if not set yet for French Beginner
// (function initFrenchBeginner() {
//   if (localStorage.getItem(storagePrefix + 'lives') === null) {
//     localStorage.setItem(storagePrefix + 'lives', '5');
//   }
//   if (localStorage.getItem(storagePrefix + 'points') === null) {
//     localStorage.setItem(storagePrefix + 'points', '0');
//   }
// })();

// // Utility to get lives
// function getLives() {
//   return parseInt(localStorage.getItem(storagePrefix + 'lives') || '5', 10);
// }

// // Utility to set lives
// function setLives(val) {
//   localStorage.setItem(storagePrefix + 'lives', val.toString());
// }

// // Utility to get points
// function getPoints() {
//   return parseInt(localStorage.getItem(storagePrefix + 'points') || '0', 10);
// }

// // Utility to set points
// function setPoints(val) {
//   localStorage.setItem(storagePrefix + 'points', val.toString());
// }

// // Update status display (call this after changes)
// function updateStatusBar() {
//   const livesCount = getLives();
//   const pointsCount = getPoints();
...
// (function(){// Namespace prefix for French Beginner
// const storagePrefix = 'fr-beginner-';
...
//   if (page === "german-quiz-q1.html" || page === "german-quiz-q1") {
...
// Utility to update status bars on each page
function updateStatusBar() {
  document.getElementById('lives-count').textContent = localStorage.getItem(storagePrefix + 'lives') || '5';
  document.getElementById('points-count').textContent = localStorage.getItem(storagePrefix + 'points') || '0';
}
updateStatusBar();
